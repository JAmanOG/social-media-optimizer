...
class SocialAction(Action):
    ...
    @field_validator("budget_fractions", mode="before")
    @classmethod
    def _coerce_budget_fractions(cls, value: Any) -> Any:
        """Accept JSON-style list strings from autogenerated web forms."""
        if value is None:
            return []
        ...
        try:
            ...
            if not parts or any(not part for part in parts):
                raise ValueError(
                    "budget_fractions must be a JSON array or comma-separated floats."
                )
