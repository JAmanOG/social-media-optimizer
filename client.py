...
class SocialMediaOptimizerClient(
    ...
    def _parse_result(
        ...
        observation = SocialObservation(
            ...
            market_trend=obs_data.get("market_trend", 0.0),
            shock_event_active=obs_data.get("shock_event_active", False),
            shock_platform=obs_data.get("shock_platform"),
            total_policy_violations=obs_data.get("total_policy_violations", 0),
            total_conversions=obs_data.get("total_conversions", 0.0),
    ...
    def _parse_state(self, payload: Dict[str, Any]) -> SocialState:
        return SocialState(
            ...
            total_policy_violations=payload.get("total_policy_violations", 0),
            total_conversions=payload.get("total_conversions", 0.0),
